...
<body>
  <div class="limiter">
    <div class="head-container">
      ...
      <input 
        ...
        class="input-id-name" 
      />
      <button class="global-buttons" onclick="window.open('login/vg_login.php')">Go to Dispense</button>
    </div>
  ...
  <aside id="orders-popup" class="avgrund-popup">
    ...
    <div class="orders-wrapper orders-details-wrapper">
      ...
      <button class="dialog-buttons" onclick="goDispense()" id="dispense_button">Go Dispense</button>
    </div>
    <br />
    <br />    
